 ...
 * @param couponId
 */
export function receiveCoupons(couponId,params) {
  return http.request({
 ...
 * @param store_id
 */
export function deleteStoreCollection(store_id,params) {
  return http.request({
...
export function getStoreIsCollect(type, store_id) {
  return http.request({
    url: `/member/collection/isCollection/${type}/${store_id}`,
    method: Method.GET,
    needToken: true,
    loading: false,
  });
 ...
 * @returns {AxiosPromise}
 */
export function collectionStore(store_id,params) {
  return http.request({
    url: `/member/collection/add/STORE/${store_id}`,
    method: Method.POST,
    needToken: true,
    params
  });
 ...
 *
 */
export function getCouponsNum(params) {
  return http.request({
...
//改用户租户状态
export function updateMemberTenantStatus(params) {
  return http.request({
    url: `/member/tenant/updateStatus`,
    needToken: true,
    method: Method.PUT,
    params
  })
...
//改用户租户状态
export function setMainTenant(params) {
  return http.request({
    url: `/member/tenant/setMain`,
    needToken: true,
    method: Method.PUT,
    params
  })
...
export function getMainTenant(params) {
  return http.request({
    url: `/member/tenant/MainTenant`,
    method: Method.GET,
    needToken: true,
    params
  });
...
//用户实名认证申请
export function userRealNameApplying(params) {
  return http.request({
    url: `/member/realName/applying`,
    method: Method.PUT,
    needToken: true,
    params
  });
