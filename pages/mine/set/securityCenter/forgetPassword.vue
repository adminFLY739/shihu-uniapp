			...
			<u-form :model="codeForm" ref="validateCodeForm">
				...
				<view v-if="validateFlage">
					<u-form-item label-width="120" label="新密码">
						<u-input type="password" v-model="password" placeholder="请输入您的新密码" />
					</u-form-item>

					<u-form-item label-width="120" label="再次输入密码">

						<u-input type="password" v-model="oncePasd" placeholder="请再次输入您的密码" />
...
<script>
	...
	export default {
		...
		methods: {
			// 修改密码
			updatePassword() {
        if (this.password !== this.oncePasd) {
