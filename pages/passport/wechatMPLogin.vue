...
<!-- 		<u-modal v-model="phoneAuthPopup" :mask-close-able="true" :title="projectName"
		...
		<view class="wx-auth-container">
			...
			<!-- 		<view>为您提供优质服务,{{ projectName }}可能会获取以下信息</view>
					<view>您的公开信息（昵称、头像）</view> -->
					<view>该小程序仅限杭师大校内师生使用,{{ projectName }}为保护学生信息安全，登陆后才能查看校内信息嗷~</view>
					<view></view>
				</view>
				<view class="btns">
					<button type="primary" @click="getUserProfile" class="btn-auth">使用微信授权</button>
	...
	export default {
		...
		methods: {
			...
			async getUserProfile(e) {
				...
				// 		console.log("uni.getUserProfile返回的信息：",res);
				...
				// 		that.nickName = "微信用户";
				// 		that.image ="https://thirdwx.qlogo.cn/mmopen/vi_32/POgEwh4mIHO4nibH0KlMECNjjGxQUq24ZEaGT4poC6icRiccVGKSyXwibcPq4BWmiaIGuG1icwxaQX6grC9VemZoJ8rg/132";
				// 		this.phoneAuthPopup = true;
				// 	},
				// });
			},
